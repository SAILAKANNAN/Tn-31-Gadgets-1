...
// MongoDB connection
mongoose.connect('mongodb+srv://sailakannans:kanna2006@cluster0.jnbvrzt.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0', { useNewUrlParser: true, useUnifiedTopology: true });
...
<head>
    ...
    <title>Tn-31 Gadgets 1 - Premium E-commerce</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="container">
        <a class="navbar-brand animate__animated animate__fadeInLeft" href="/">
            ...
            <span class="fw-bold">Tn-31 Gadgets 1 </span>
        </a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 mb-4">
                    <h5><i class="fas fa-shopping-bag me-2"></i> Tn-31 Gadgets 1 Shop</h5>
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <ul class="list-unstyled text-muted">
                        <li class="mb-2"><i class="fas fa-map-marker-alt me-2"></i> Nellikuppam , Cuddalore</li>
                        <li class="mb-2"><i class="fas fa-phone me-2"></i> 7010138563</li>
                        <li class="mb-2"><i class="fas fa-envelope me-2"></i> fawazfawa162@gmail.com</li>
                    </ul>
                </div>
            </div>
    ...
    <div class="popup-overlay" id="contact-popup">
        <div class="popup-content">
            ...
            <div class="row">
                <div class="col-md-6">
                    <h4>Get in Touch</h4>
                    <p><i class="fas fa-map-marker-alt me-2"></i>Nellikuppam,Cuddalore</p>
                    <p><i class="fas fa-phone me-2"></i>7010138563</p>
                    <p><i class="fas fa-envelope me-2"></i>fawazfawa162@gmail.com</p>
                    <p><i class="fas fa-clock me-2"></i> Monday-Sunday: 24 Hours</p>
                    <img src="https://drive.google.com/file/d/14IicYh3JfiD2PU-HzBcyiz-TPU3sqK_b/view" alt="">
                </div>
...
app.post('/login', async (req, res) => {
    ...
    if (username === 'tn31gadgets1' && password === 'fawaz') {
        adminLoggedIn = true;
                    ...
                    <div class="modal-body">
                        ...
                        <div class="contact-info">
                            ...
                            <div class="contact-method">
                                ...
                                <span>24/7 Support Hotline:7010138563</span>
                            </div>
                            <div class="contact-method">
                                <i class="fas fa-envelope"></i>
                                <span>Email:  fawazfawa162@gmail.com</span>
                            </div>
                            <div class="contact-method">
                                <i class="fas fa-comment-alt"></i>
                                <span>whatsapp Chat: 7010138563 </span>
                            </div>
                            <div class="contact-method">
                    ...
                    <div class="modal-body">
                        <div class="contact-info">
                            ...
                            <div class="contact-method">
                                ...
                                <span>Rich Nellikuppam, Cuddalore</span>
                            </div>
                            <div class="contact-method">
                                <i class="fas fa-phone-alt"></i>
                                <span>Main Office: 7010138563</span>
                            </div>
                            <div class="contact-method">
                                <i class="fas fa-envelope"></i>
                                <span>General Inquiries: fawazfawa162@gmail.com</span>
                            </div>
                            <div class="contact-method">
                                <i class="fas fa-clock"></i>
                                <span>Business Hours: Monday-sunday,24 Hours</span>
                            </div>
                        </div>
                                ...
                                ${user.cart.map(item => `
                                    <div class="cart-item row align-items-center">
                                        ...
                                        <div class="col-9">
                                            ...
                                            <p class="mb-1">If you want cash on delivery pay 100.</p>
                                            <p class="mb-1">If you want UPI Payment pay 100 + ₹${item.price * item.quantity} .</p>
...
<div class="container mt-3 px-3">
    <div class="qr-container text-center p-3 rounded-4 shadow-sm" style="max-width: 100%; background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); border: 1px solid rgba(0,0,0,0.08);">
        <p class="fw-bold mb-2 fs-6 text-primary">Pay to QR code take screen shot</p>
          <img src="/qr.jpeg" 
        ...
        <div class="mt-2">
            <p class="text-muted small mb-0" style="font-size: 0.7rem;"><i class="bi bi-info-circle-fill text-primary me-1"></i> Open any UPI app to complete payment</p>
        </div>
    </div>
</div>
...
<!-- Optional JavaScript for copy functionality -->
<script>
                                    ...
                                    <div class="product-card p-3 animate__animated animate__fadeInUp animate-delay-${index % 3 + 1}">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                ${product.size ? `<p class="mb-1 small text-muted">Payment method: ${product.size}</p>` : ''}
                    ...
                    <div class="col-lg-10">
                        ...
                        <form action="/admin/addproduct" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-section animate__animated animate__fadeInUp animate__delay-2s">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <label class="form-label">Payment method (comma separated)</label>
...
app.post('/admin/addproduct', upload.fields([
    ...
    try {
        const {
            name, category, brand, 
            price, mrp, discount, stock, lowStockAlert, 
            sizes, colors, 
